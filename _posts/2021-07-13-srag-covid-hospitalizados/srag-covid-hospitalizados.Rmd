...
Durante o período de `r format(dt_inicial,"%d de %B de %Y")` a `r format(dt_final,"%d de %B de %Y")` internaram nos Hospitais de Porto Alegre (SUS e privados) `r mil(n_internados_poa)` pacientes () (Fonte: SIVEP Gripe)
